...
export async function createProviderAccount(input: ProviderAccountInput): Promise<ActionResult> {
  ...
  if (error) return { error: "No se pudo crear la cuenta de proveedor. " + error.message }
